...
1. Using NetDiscover, Nmap and a simple ifconfig command, it was uncovered the Ip address of the Linux web server is 192.168.1.105 and that port 22 was accessible. 
